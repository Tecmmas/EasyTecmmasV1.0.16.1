                                                        ...
                                                        <tr>
                                                            <td style="text-align: center;">
                                                                <select class="select-css" name='idactualizacion' id="idactualizacion">
                                                                    <option disabled="disabled" selected="selected">Seleccionar Version</option>
                                                                    <?php foreach ($actu as $value): ?>
                                                                        <option value="<?= $value->id ?>"><?= $value->version ?></option>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </td> 
                                                            <td style="text-align: center; margin-top: 2px">       
                                                                <label style="font-weight: bold; color: black"></label>
                                                                <input type="submit" name="consultar" id="btn-descarga" class="btn btn-accent btn-block" onclick="showSuccess('Descargando actualizacion, por favor espere.')" style="background-color: #393185;border-radius: 40px 40px 40px 40px" value="Descargar">
                                                            </td>
                                                        </tr>
...
<script type="text/javascript">
    $('#idactualizacion').change(function () {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>index.php/oficina/descargas/Cdescargas/getDescripcion',
            type: 'post',
            mimeType: 'json',
